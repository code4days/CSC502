...
Author: Tim McCord
Course/Project: CSC 402/502 Spring 2015, Project3 
...
// CSC 502 students should uncomment this preprocessor directive for R11.  
#define CSC502
...
int main( )
{
  ...
  cout << endl <<  "Integer constructors, =, and << tests:" << endl << SEPARATOR << endl ; 
  ...
  cout << "i2 = " << i2 << endl ;
     ...
     cout << endl <<  "Character constructors, =, and << tests:" << endl << SEPARATOR << endl ;
...
//        Integer *ip2 = new Integer(1);
       ...
       *cp2 = *cp1 ;
       ...
       // Item of interest, re: using std::sort out of the box with a vector of Integers,
       //   as opposed to IComparable pointers.
       vector<Integer> v ;
       for (int i = 10; i > 0; i--)
         v.push_back(i) ;
       cout << "Unsorted vector of Integer objects (not pointers!!!)" << endl << SEPARATOR << endl ;
       ...
       delete ip1, ip2, cp1, cp2 ;


  // more universal way of making the program pause for those not using VS 
	//cin.get() ;
  return 0 ;
